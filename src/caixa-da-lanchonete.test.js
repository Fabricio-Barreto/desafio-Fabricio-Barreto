...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['dinheiro', 'R$ 82,56', ['combo1,2','cafe,2','combo2,2','chantily,2','suco,2','sanduiche,2','queijo,2','salgado,2']],
        ['debito', 'R$ 86,90', ['combo1,2','cafe,2','combo2,2','chantily,2','suco,2','sanduiche,2','queijo,2','salgado,2']],
        ['credito', 'R$ 89,51', ['combo1,2','cafe,2','combo2,2','chantily,2','suco,2','sanduiche,2','queijo,2','salgado,2']],
    ])('Comprar todos os itens com %p dará %p', validaTeste)
